    ...
    return (
        ...
        >

            {
                isMounted() ?
                    (theme === "light" ?
                        <Image src="/images/sun.svg" alt="sun_svg" width={24} height={24} /> : <Image src="/images/moon.svg" alt="sun_svg" width={24} height={24} />) :
                    <Image src="/images/moon.svg" alt="sun_svg" width={24} height={24} />
            }
        </button >
    )
}
