...
const ToggleTheme = () => {
    ...
    return (
        ...
        <button
            onClick={toggleTheme}
            className="w-[1.6rem] ease hover:bg-foreground/5 ml-3 flex items-center justify-center rounded-full p-1 text-zinc-900 dark:text-zinc-300"
...
export { ToggleTheme, MoonSvg, SunSvg }
