...
const AboutMe = () => {
    ...
    return (
        <div className="flex csm:flex-col-reverse justify-center items-center">
            <div className="flex flex-col relative gap-6">
                <p className={cn("ease-in-out transition-all duration-700 opacity-0 translate-y-5", clicked && "opacity-100 translate-y-0")} ><span className="text-blue-600 dark:text-blue-400">cybergaz</span> : it's my internet name, you can find me pretty much everywhere with this username. try googling <span className="text-blue-600 dark:text-blue-400">cybergaz</span> and top results should be affiliated to me. </p>
                <p className={cn("absolute ease-in-out transition-all duration-700", clicked && "opacity-0 ")} > I'm <span className="text-blue-600 dark:text-blue-400">Krishan Kant</span> a self-driven & dedicated software developer specializing in <span className="underline decoration-blue-500 underline-offset-4">full-stack development</span> and a deep engagement in open-source innovation. </p>
