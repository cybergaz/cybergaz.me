            ...
            <div className="flex flex-col gap-32 justify-center items-center">
                ...
                >
                    <a href="mailto:gaz.sync@gmail.com" target="_blank" >
                        <div className="bg-gradient-to-br active:scale-90 sm:scale-90 transition-transform duration-300 shadow-2xl shadow-violet-700 from-foreground via-background to-blue-500 p-[3px] rounded-[0.9rem] flex justify-center items-center">
