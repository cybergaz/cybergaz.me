    ...
    return (
        <section className=" pt-44 sm:pt-32 max-w-6xl px-5 mx-auto font-baloo font-normal text-lg">
            <div className="flex flex-col gap-32 justify-center items-center">
                <div
                    className="motion-preset-slide-down-lg motion-duration-1000 motion-ease-out motion-delay-300 order-1 relative place-self-center "
                ...
                <div className=" order-2 sm:-mt-14 -mt-8 flex flex-col justify-center items-center space-y-9" >
                    <div
                        className="motion-preset-slide-up-lg motion-delay-100 motion-duration-1000 flex flex-col justify-center items-center space-y-9"
                    // initial={{ opacity: 0, y: 60 }}
                    // animate={{ opacity: 1, y: 0 }}
                    ...
                    <div
                        className="motion-preset-slide-up-lg motion-delay-500 motion-duration-1000 flex flex-col justify-center items-center text-2xl csm:text-center [@media(max-width:640px)]:text-left sm:text-xl csm:leading-8 leading-9 font-baloo dark:text-neutral-400 "
